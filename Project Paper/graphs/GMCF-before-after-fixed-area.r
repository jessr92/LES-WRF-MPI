...
plot(data$processes, data$before, log="xy",type="o", col=plot_colours[1], ylim=y_range, xlim=x_range, axes=TRUE, ann=FALSE)

lines(data$processes, data$after, type="o", col=plot_colours[2], ylim=y_range, xlim=x_range, ann=FALSE)
