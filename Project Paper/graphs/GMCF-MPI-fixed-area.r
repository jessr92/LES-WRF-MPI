...
plot(data$processes, data$mpi, log="xy",type="o", col=plot_colours[1], ylim=y_range, xlim=x_range, axes=TRUE, ann=FALSE)

lines(data$processes, data$gmcf, type="o", col=plot_colours[2], ylim=y_range, xlim=x_range, ann=FALSE)
