...
\frame{
    ...
    \begin{itemize}
        \item MPI and GMCF had shared-memory evaluation on togian
        \item togian has 64 cores across 4 sockets
        \item MPI had distributed-memory evaluation on ARCHIE
...
\frame{
    ...
    \begin{itemize}
        ...
        \item Fixed area has linear scaling. Around 7x improvement over 64 cores
        \item Expanding area scales well. Runtime settles to 220 seconds
    \end{itemize}
}
...
\frame{
    ...
    \begin{itemize}
        ...
        \item Preemptive data sending and more granular FIFOs reduced runtime by nearly 50\%
    \end{itemize}
}
