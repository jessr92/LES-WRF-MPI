...
! --les
...
#ifdef MPI
    call exchangeRealHalos(nou1, procPerRow, neighbours, 2, 2, 1, 2)
    call exchangeRealHalos(diu1, procPerRow, neighbours, 2, 2, 1, 2)
    call exchangeRealHalos(cov1, procPerRow, neighbours, 2, 2, 1, 2)
    ...
    call exchangeRealHalos(nou5, procPerRow, neighbours, 2, 2, 1, 2)
    call exchangeRealHalos(diu5, procPerRow, neighbours, 2, 2, 1, 2)
    call exchangeRealHalos(cov5, procPerRow, neighbours, 2, 2, 1, 2)
